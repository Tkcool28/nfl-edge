...
export class ApiClient {
  ...
  profile(){return this.request('/api/v1/profile');} updateProfile(body){return this.request('/api/v1/profile',{method:'PUT',body});} bankroll(){return this.request('/api/v1/bankroll');} productLatest(){return this.request('/api/v1/product/latest');} newsLatest(){return this.request('/api/v1/news/latest');} games(){return this.request('/api/v1/games');} game(id){return this.request(`/api/v1/games/${encodeURIComponent(id)}`);} evaluateOffer(body){return this.request('/api/v1/evaluate-offer',{method:'POST',body});}

...
class BackendSettings:
    ...
    news_editorial_inbox_path: Path = Path("data/runtime/news_v1/editorial_submissions/candidate.json")
        ...
        return cls(
            ...
            news_editorial_inbox_path=Path(
                os.getenv(
                    ...
                    "data/runtime/news_v1/editorial_submissions/candidate.json",
                )
            ),
            news_editorial_bearer_token=os.getenv("NFL_EDGE_NEWS_EDITORIAL_BEARER_TOKEN", ""),

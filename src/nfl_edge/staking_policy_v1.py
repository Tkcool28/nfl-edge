...
This neutral module is the single authoritative implementation of the frozen
staking semantics.  The legacy ``nfl_edge.recommendation.staking_v1`` module
re-exports this surface for compatibility without forcing contract consumers
through ``nfl_edge.recommendation.__init__``.
"""

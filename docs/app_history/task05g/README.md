...
The retired branches above culminated in the production merge chain:

`#50 -> #51 -> #52 -> #56`

Those merged PRs, together with current `main`, are the production reference. The retired PRs in this index are research provenance only.
